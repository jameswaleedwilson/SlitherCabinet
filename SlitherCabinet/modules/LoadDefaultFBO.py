...
class LoadDefaultFBO:
    ...
    def draw_default_fbo(self, camera, lights, zoom, roll, pitch, yaw, view,
                         object_color_identifier_default_fbo=None,
        ...
        #
        if object_color_identifier_default_fbo is not None:
            object_color_identifier_default_fbo = ShaderUniforms("ivec3", object_color_identifier_default_fbo)
            object_color_identifier_default_fbo.find_variable(self.shader.link_shader,
                                                              "object_color_identifier_default_fbo")
            object_color_identifier_default_fbo.load()
